...
def main():
    ...
    print(dynamoRepo.update_dynamo_event_counter('324', 20171001, 1))
    print( dynamoRepo.update_dynamo_event_counter('324', 20171001, 2))
    print( dynamoRepo.update_dynamo_event_counter('324', 20171002, 5))
